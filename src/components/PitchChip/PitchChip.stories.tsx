    ...
    docs: {
      description: {
        component: [
          ...
          "**blue for 3**. Pitch is the central tension of the game, because a red card is",
          "the strongest version of itself and the worst resource, and the blue is the",
          "reverse. The value is data, not decoration.",
          "",
          "**Pitch is never carried by colour alone.** Colour vision deficiency runs at",
          "roughly 1 in 12 men, and trading card games skew heavily male, so a red/blue",
          "distinction shown only as a hue is unreadable for a fair share of players. It is",
          "unreadable again in a deck list printed in greyscale for a judge. So the chip",
          "always renders the numeral, and always carries a deliberate accessible name",
          "(`Pitch 3 (blue)`) from a visually hidden span. `showValue` adds a visible",
