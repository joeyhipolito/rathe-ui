    ...
    docs: {
      description: {
        component: [
          ...
          "single most load-bearing fact in an event listing — it tells a player how far they",
          "have to travel, how much it costs, and what they win:",
          "",
          "| Tier | Events |",
          "| --- | --- |",
          ...
          "because that is how LSS sets it — but `IV` read aloud is ambiguous (a screen reader",
          "will say \"eye vee\"), so the accessible name is always plain and expanded:",
          '"Tier 4, Pro Tour and World Championship". Second, Tier 4 is the visual apex and',
          "uses the gold tokens as **ground and rule, never as type** — `--rathe-gold` sits at",
          "0.70L in light and 0.78L in dark, so gold text fails contrast on both papers.",
        ].join("\n"),
      },
    },
  },
...
/** Tier 1 — a weekly Armory. Quietest in the ladder; it should not shout in a listing of fifty. */
